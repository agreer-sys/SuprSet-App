...
const EQUIPMENT_PRESETS = [
  ...
  "Glute Bridge Machine (Plate Loaded)", "Glute Ham Raise Unit", "Glute Kickback Machine", 
  "Hack Squat Machine (Cable Stack)", "Hack Squat Machine (Plate Loaded)", "Incline Chest Press Machine", 
  "Jacobs Ladder", "Jump Rope", "Kettlebells", "Lateral Raise Machine", "Lat Pulldown Machine", 
  "Laying Leg Curl Machine", "Leg Curl Machine", "Leg Extension / Leg Curl Machine", "Leg Extension Machine", 
  "Leg Press Machine (Cable Stack)", "Leg Press Machine (Plate Loaded)", "Loop Band", "Machine Row", 
  "Mat", "Medicine Ball", "Nordic Hamstring Curl Machine", "Olympic Decline Bench", "Olympic Flat Bench", 
  "Olympic Incline Bench", "Olympic Military Bench", "Olympic Plate Tree", "Pec Fly Machine", 
